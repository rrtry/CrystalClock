...
(() => {
    ...
    function loadPackage(metadata) {
        ...
        var PACKAGE_NAME = "C:/Users/Fedor/Projects/CrystalClock/bin/Release/CrystalClock.data";
        var REMOTE_PACKAGE_BASE = "CrystalClock.data";
        ...
        function runWithFS(Module) {
            ...
            function processPackageData(arrayBuffer) {
                ...
                Module["removeRunDependency"]("datafile_C:/Users/Fedor/Projects/CrystalClock/bin/Release/CrystalClock.data")
            }
            Module["addRunDependency"]("datafile_C:/Users/Fedor/Projects/CrystalClock/bin/Release/CrystalClock.data");
    ...
    loadPackage({
        files: [{
            ...
            filename: "/resources/prism.obj",
            start: 357,
            end: 2437
        }, {
            filename: "/resources/shaders/glsl100/crystal.fs",
            start: 2437,
            end: 5799
        }, {
            filename: "/resources/shaders/glsl100/crystal.vs",
            start: 5799,
            end: 7057
        }, {
            filename: "/resources/shaders/glsl100/orb.fs",
            start: 7057,
            end: 7420
        }, {
            filename: "/resources/shaders/glsl100/tunnel.fs",
            start: 7420,
            end: 9158
        }, {
            filename: "/resources/shaders/glsl100/tunnel.vs",
            start: 9158,
            end: 9713
        }, {
            filename: "/resources/shaders/glsl330/crystal.fs",
            start: 9713,
            end: 13230
        }, {
            filename: "/resources/shaders/glsl330/crystal.vs",
            start: 13230,
            end: 14277
        }, {
            filename: "/resources/shaders/glsl330/orb.fs",
            start: 14277,
            end: 14624
        }, {
            filename: "/resources/shaders/glsl330/tunnel.fs",
            start: 14624,
            end: 16330
        }, {
            filename: "/resources/shaders/glsl330/tunnel.vs",
            start: 16330,
            end: 16841
        }, {
            filename: "/resources/sound/waves.ogg",
            start: 16841,
            end: 993311,
            audio: 1
        }, {
            filename: "/resources/textures/halo.png",
            start: 993311,
            end: 1113223
        }, {
            ...
            filename: "/resources/textures/normal.jpg",
            start: 3113266,
            end: 3375410
        }],
        remote_package_size: 3375410
    })
})();
...
function findWasmBinary() {
    return locateFile("CrystalClock.wasm")
}
...
var ASM_CONSTS = {
    ...
    101842: () => navigator.mediaDevices !== undefined && navigator.mediaDevices.getUserMedia !== undefined,
    101946: () => {
        try {
    ...
    104945: $0 => miniaudio.get_device_by_index($0).webaudio.sampleRate,
    105011: $0 => {
    ...
    105744: () => document.getElementById("canvas").width,
    105796: () => parseInt(document.getElementById("canvas").style.width),
    105864: () => {
    ...
    106010: () => document.getElementById("canvas").width,
    106062: () => screen.width,
    106087: () => {
        document.exitFullscreen()
    },
    ...
    106247: () => window.innerWidth,
    106273: () => window.innerHeight,
    106300: () => {
        if (document.fullscreenElement) return 1
    },
    106346: () => document.getElementById("canvas").width,
    106398: () => parseInt(document.getElementById("canvas").style.width),
    106466: () => {
        if (document.fullscreenElement) return 1
    },
    106512: () => document.getElementById("canvas").width,
    106564: () => screen.width,
    106589: () => window.innerWidth,
    106615: () => window.innerHeight,
    106642: () => {
        if (document.fullscreenElement) return 1
    },
    106688: () => document.getElementById("canvas").width,
    106740: () => screen.width,
    106765: () => {
        document.exitFullscreen()
    },
    ...
    106838: () => document.getElementById("canvas").width,
    106890: () => parseInt(document.getElementById("canvas").style.width),
    106958: () => {
        document.exitFullscreen()
    },
    106985: $0 => {
    ...
    107043: () => screen.width,
    107068: () => screen.height,
    107094: () => window.screenX,
    107121: () => window.screenY,
    107148: $0 => {
    ...
    107702: () => window.innerWidth,
    107728: () => window.innerHeight,
    107755: () => {
